...
function validateForm(){
    ...
    if (compPhone2.length!=10){
        seterror("phone2", "Phone number should be of 10 digit");
        returnval = false;
    }
 return returnval;
...
// let insured = document.forms['myForm']["cpointCntTitle"].value;
// let bond = document.forms['myForm']["cpointCntTitle"].value;
// let license = document.forms['myForm']["cpointCntTitle"].value;
